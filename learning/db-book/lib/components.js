...
(function () {
  ...
  CB.CHAPTERS = [
    { p: "I",   no: 1,  slug: "ch01-sql",                  t: "SQL：声明式接口", ready: true },
    { p: "I",   no: 2,  slug: "ch02-relational-model",     t: "关系模型与代数", ready: true },
    { p: "II",  no: 3,  slug: "ch03-disks-files-buffers",  t: "磁盘、文件、Buffer Pool", ready: true },
    { p: "II",  no: 4,  slug: "ch04-cost-indexes",         t: "代价模型与索引选择", ready: true },
    { p: "II",  no: 5,  slug: "ch05-btree",                t: "B+ 树：十亿行里一步命中", ready: true },
    { p: "III", no: 6,  slug: "ch06-sorting-hashing",      t: "排序与哈希", ready: true },
    { p: "III", no: 7,  slug: "ch07-joins-iterators",      t: "Joins 与 Iterator 模型", ready: true },
    { p: "III", no: 8,  slug: "ch08-query-optimization",   t: "查询优化器", ready: true },
    { p: "IV",  no: 9,  slug: "ch09-locking",              t: "事务、锁与隔离", ready: true },
    { p: "IV",  no: 10, slug: "ch10-recovery",             t: "Recovery 与 ARIES", ready: true },
    { p: "V",   no: 11, slug: "ch11-distributed-txns",     t: "2PC、Paxos 与分布式事务", ready: true },
    { p: "V",   no: 12, slug: "ch12-nosql-modern",         t: "NoSQL、Spark 与现代数据系统", ready: true }
  ];
  CB.renderSidebar = function () {
    ...
    CB.CHAPTERS.forEach(function (ch) {
      ...
      if (ch.no === cur) {
        ...
        nav.appendChild(el("a", { class: "toc-link locked", href: "#" },
          [el("span", { class: "num", text: num }), document.createTextNode(" " + ch.t)]));
      }
    });
  };
